...
public class nivel8 extends javax.swing.JFrame {
Start start= new Start();
public  int numerorandom= (int)(Math.random()*80+1);
    public nivel8() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(64, 27, 101));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Nivel ocho");
            ...
            if(numerorandom==numero){
                ...
                if(start.Statusvida==0){
                    ...
                    if(JOptionPane.showConfirmDialog(null, "¿desea volver a la pantalla de inicio?", "advertencia",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                        dispose();
                        numerorandom= (int)(Math.random()*80+1);
                        start.Statusvida=3;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nivel8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
