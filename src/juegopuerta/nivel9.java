 ...
 * @author alexander
 */
public class nivel9 extends javax.swing.JFrame {
Start start= new Start();
public  int numerorandom= (int)(Math.random()*90+1);
    public nivel9() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(101, 54, 54));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Nivel nueve");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(numerorandom==numero){
                ...
                nivelfinal nivel = new nivelfinal();
                ...
                if(start.Statusvida==0){
                    ...
                    if(JOptionPane.showConfirmDialog(null, "¿desea volver a la pantalla de inicio?", "advertencia",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                        dispose();
                        numerorandom= (int)(Math.random()*90+1);
                        start.Statusvida=3;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nivel9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
