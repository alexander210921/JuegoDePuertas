 ...
 * @author alexander
 */
public class nivel6 extends javax.swing.JFrame {
Start start= new Start();
public  int numerorandom= (int)(Math.random()*60+1);
    public nivel6() {
        initComponents();
            ...
            if(numerorandom==numero){
                ...
                if(start.Statusvida==0){
                    ...
                    if(JOptionPane.showConfirmDialog(null, "¿desea volver a la pantalla de inicio?", "advertencia",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                        dispose();
                        numerorandom= (int)(Math.random()*60+1);
                        start.Statusvida=3;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nivel6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
