...
public  int numerorandom= (int)(Math.random()*30+1);
    public nivel3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(13, 124, 84));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Nivel tres");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println(numerorandom); //para poder visualizar el numero a ingresar y probar el programa
        try{
            ...
            if(numerorandom==numero){
                ...
                if(start.Statusvida==0){
                    ...
                    if(JOptionPane.showConfirmDialog(null, "¿desea volver a la pantalla de inicio?", "advertencia",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                        dispose();
                        numerorandom= (int)(Math.random()*30+1);
                        start.Statusvida=3;
