...
public class nivel7 extends javax.swing.JFrame {
Start start= new Start();
public  int numerorandom= (int)(Math.random()*70+1);
    public nivel7() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println(numerorandom);// para poder ver el numero a ingresar y evaluar el programa
        try{
            ...
            if(numerorandom==numero){
                ...
                if(start.Statusvida==0){
                    ...
                    if(JOptionPane.showConfirmDialog(null, "¿desea volver a la pantalla de inicio?", "advertencia",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                        dispose();
                        numerorandom= (int)(Math.random()*70+1);
                        start.Statusvida=3;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nivel7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
