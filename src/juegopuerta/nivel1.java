...
public  int numerorandom= (int)(Math.random()*10+1);
    public nivel1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(99, 45, 51));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Nivel uno");
...
int numero=Integer.parseInt(numerodelusuario);
    if(numerorandom==numero){
        ...
        nivel2 nivl= new nivel2();
        nivl.setVisible(true);
        dispose();
    }else{        
